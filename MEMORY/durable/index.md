...
Read the matching file before deep work. Update it when you learn something lasting.
...
Session scratch: `../sessions/` (gitignored). Promote lasting notes here before ending a task.
