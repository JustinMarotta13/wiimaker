...
use wiimaker_scene::{
    ...
    list_scenes, load_project, load_scene, remove_entity, rename_entity, save_scene,
    set_entity_transform, set_scene_clear, write_scene_wscn, GameProject, MutateOpts, Scene,
};
